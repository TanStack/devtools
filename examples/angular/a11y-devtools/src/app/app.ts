...
@Component({
  ...
  template: `
    <div style="padding: 20px; font-family: system-ui, sans-serif">
      ...
      <p>
        This page contains intentional accessibility issues to demonstrate the A11y devtools plugin.
        Open the devtools panel and click "Run Audit" to see the issues.
      </p>
      ...
      <section
        style="margin-top: 32px; padding: 16px; background-color: #f5f5f5; border-radius: 8px"
      >
        ...
        <div style="margin-bottom: 16px">
          ...
          <button aria-label="Close dialog" style="width: 40px; height: 40px; font-size: 20px">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        ...
        <div style="margin-bottom: 16px">
          ...
          <label for="name-input" style="display: block; margin-bottom: 4px"> Your Name </label>
